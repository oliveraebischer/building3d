    ...
    <div className="w-full h-full min-h-screen bg-[#0d0d0d] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#161616] border border-white/[0.07] rounded-xl p-8">
          <h1 className="text-base font-semibold text-white/90 mb-6">Create your account</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-[11px] text-white/40 mb-1.5">Confirm password</label>
              <input
                type="password"
                required
                value={confirm}
